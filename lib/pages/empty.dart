...
import 'package:ramchin_technologies_pvt_ltd/pages/product/features_page.dart';
...
class _SchoolPageState extends State<SchoolPage>
  ...
  Future<void> _openPdf() async {
    // For web, use url_launcher for opening in a new tab, absolute path preferred
    ...
    if (await canLaunchUrl(uri)) {
      await launchUrl(
        uri,
        mode: LaunchMode.externalApplication, // Opens in a new tab/window
      );
    } else {
